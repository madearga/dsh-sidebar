#!/usr/bin/env bash
# =============================================================================
# dsh-sidebar 一键安装脚本（官方 CLI 方式，macOS / Linux / Windows Git Bash）
#
...
#   （Node 半挂两次、页面两个侧边栏）。脚本会幂等移除 dsh-sidebar 挂载行。
# - 回滚：dsh plugin --profile web remove dsh-sidebar，或把 profile 依赖
#   改回 "dsh-sidebar": "link:<路径>" 再 pnpm install。
# =============================================================================
set -euo pipefail
