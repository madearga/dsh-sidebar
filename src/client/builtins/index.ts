 ...
 * previewers through the same {@link SidebarService} external plugins
 ...
 * (EditorHost reads `ctx.dshSidebar` for file-viewer matching).
 */
export function registerBuiltins(ctx: Context, service: SidebarService): () => void {
