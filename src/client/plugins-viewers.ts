...
export const builtinViewerPlugins: readonly PluginEntry[] = [
  {
    id: '@huanlin/dsh-plugin-dsh-sidebar-plugin-office',
    name: 'Office 预览插件',
    url: 'https://github.com/HuanLinOTO/dsh-plugin-dsh-sidebar-plugin-office',
    description: () => t('pluginOfficeDesc'),
    install: 'cd ~/.dsh && dsh plugin --profile web add @huanlin/dsh-plugin-dsh-sidebar-plugin-office',
  },
]
