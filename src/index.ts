/**
 * dsh-sidebar host half: the /sidebar JSON API (explorer listing, file
...
// `import type {} from 'dsh-sidebar'` and gain `ctx.dshSidebar`.
...
export function apply(ctx: Context, config?: SidebarConfig): void {
  ...
  }), 'dsh-sidebar: /sidebar/api routes')
  ...
  ctx.effect(() => registerBundleRoute(ctx, fence), 'dsh-sidebar: /sidebar/bundle chunk route')
  ...
  }), 'dsh-sidebar: /sidebar/file media route')
  ...
  }), 'dsh-sidebar: terminal WebSocket')
  ...
  }), 'dsh-sidebar: agent-terminals push WebSocket')
