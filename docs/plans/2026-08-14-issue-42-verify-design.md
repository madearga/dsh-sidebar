...
[issue #42](https://github.com/madearga/DSH-sidebar/issues/42)（Windows 11 / QQBrowser / dsh-launcher 宿主 / 插件 0.10.3）：
...
与 [issue #25](https://github.com/madearga/DSH-sidebar/issues/25)（WKWebView 底部面板终端空白）完全同源，证据链：
